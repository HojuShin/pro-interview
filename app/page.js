    ...
    <div className="container">
      <main className="main">
        <div className="main-left">
          <h1 className='main-left-logo'><span className='main-left-color'>PRO</span></h1>
          <div className='main-session'>
            <p className='main-left-desc'><span className='main-left-color'>PRO</span>로 더 나은 미래를 준비하세요</p>
            {
